(function () {
    ...
    var element = document.getElementById('divddlCharacteristicType');
    ...
    element.addEventListener('dragstart', function (e) {
        ...
        sourceID = 0;
        sourceID = e.target.parentNode.id;
    ...
    element.addEventListener('dragend', function (e) {
        ...
        if (selections.droptarget) {
            ...
            if (document.getElementById('dragvalues') != undefined && document.getElementById('dragvalues') != null) {
                if ((TargetID == "GPoP" || TargetID == "APoP" || TargetID == "LLPoP") && (sourceID == "GPoP" || sourceID == "APoP" || sourceID == "LLPoP")) {
                    ...
                    for (var len = selections.items.length, i = 0; i < len; i++) {
                        ...
                        //alert($("#" + selections.items[i].id).find('p').text());  

                        selections.droptarget.appendChild(selections.items[i]);
                        addvalue += $("#" + selections.items[i].id).find('p').text().trim() + ",";

                    }
                    document.getElementById('dragvalues').value += addvalue;
                    if (savedata(addvalue, sourceID, TargetID) == false) {
                        e.preventDefault();
                    }
                }
            ...
            else if (document.getElementById('dragPortvalues') != undefined && document.getElementById('dragPortvalues') != null) {
                for (var len = selections.items.length, i = 0; i < len; i++) {
                ...
                document.getElementById('dragPortvalues').value += addvalue;
                if (savePortdata(addvalue, sourceID, TargetID) == false) {
                    e.preventDefault();
                }
            }
            else {
